...
<template>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <router-link to="/home" class="nav-link link-dark font-scrum2" aria-current="page">
      ...
      <li>
        <router-link to="/cluster" class="nav-link link-dark font-scrum2">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
      ...
      <li>
        <router-link to="/task" class="nav-link link-dark font-scrum2" v-if="role != 'leader'">
      ...
      <li>
        <router-link to="/store" class="nav-link link-dark font-scrum2">
