  ...
  "node_modules/bootstrap/dist/js/bootstrap.min.js"(exports, module) {
    !function(t, e) {
      ...
      function N(t2, e2, i2) {
        ...
        let o2 = j(t2);
        return I.has(o2) || (o2 = t2), [s2, n2, o2];
      }
      function P(t2, e2, i2, s2, n2) {
        ...
        const d2 = O(r2, e2.replace(A, "")), u2 = o2 ? function(t3, e3, i3) {
      ...
      function j(t2) {
        return t2 = t2.replace(T, ""), L[t2] || t2;
      }
      ...
      const bt = "dropdown", vt = "ArrowUp", yt = "ArrowDown", wt = "click.bs.dropdown.data-api", At = "keydown.bs.dropdown.data-api", Tt = "show", Et = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)', Ct = `${Et}.show`, kt = ".dropdown-menu", Lt = m() ? "top-end" : "top-start", It = m() ? "top-start" : "top-end", Ot = m() ? "bottom-end" : "bottom-start", St = m() ? "bottom-start" : "bottom-end", Dt = m() ? "left-start" : "right-start", Nt = m() ? "right-start" : "left-start", Pt = { autoClose: true, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" }, xt = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
      class Mt extends V {
        constructor(t2, e2) {
          super(t2, e2), this._popper = null, this._parent = this._element.parentNode, this._menu = U.next(this._element, kt)[0] || U.prev(this._element, kt)[0], this._inNavbar = this._detectNavbar();
        }
        static get Default() {
          return Pt;
        }
          ...
          if (!$.trigger(this._element, "show.bs.dropdown", t2).defaultPrevented) {
            if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))
              for (const t3 of [].concat(...document.body.children))
                $.on(t3, "mouseover", _);
            this._element.focus(), this._element.setAttribute("aria-expanded", true), this._menu.classList.add(Tt), this._element.classList.add(Tt), $.trigger(this._element, "shown.bs.dropdown", t2);
          }
        }
        hide() {
          if (d(this._element) || !this._isShown())
        ...
        _completeHide(t2) {
          if (!$.trigger(this._element, "hide.bs.dropdown", t2).defaultPrevented) {
            if ("ontouchstart" in document.documentElement)
              for (const t3 of [].concat(...document.body.children))
                $.off(t3, "mouseover", _);
            this._popper && this._popper.destroy(), this._menu.classList.remove(Tt), this._element.classList.remove(Tt), this._element.setAttribute("aria-expanded", "false"), W.removeDataAttribute(this._menu, "popper"), $.trigger(this._element, "hidden.bs.dropdown", t2);
          }
        }
        _getConfig(t2) {
        ...
        _getPlacement() {
          ...
          return t2.classList.contains("dropup") ? e2 ? It : Lt : e2 ? St : Ot;
        }
        _detectNavbar() {
        ...
        static dataApiKeydownHandler(t2) {
          ...
          if (e2 && !i2)
            return;
          t2.preventDefault();
          const n2 = this.matches(Et) ? this : U.prev(this, Et)[0] || U.next(this, Et)[0], o2 = Mt.getOrCreateInstance(n2);
          if (s2)
            return t2.stopPropagation(), o2.show(), void o2._selectMenuItem(t2);
          o2._isShown() && (t2.stopPropagation(), o2.hide(), n2.focus());
        }
      }
      $.on(document, At, Et, Mt.dataApiKeydownHandler), $.on(document, At, kt, Mt.dataApiKeydownHandler), $.on(document, wt, Mt.clearMenus), $.on(document, "keyup.bs.dropdown.data-api", Mt.clearMenus), $.on(document, wt, Et, function(t2) {
      ...
      class Pe extends V {
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (s2.append(i2), $.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(i2), i2.classList.add(Ce), "ontouchstart" in document.documentElement)
            for (const t3 of [].concat(...document.body.children))
              $.on(t3, "mouseover", _);
          this._queueCallback(() => {
        ...
        hide() {
          ...
          if (t2.classList.remove(Ce), "ontouchstart" in document.documentElement)
            for (const t3 of [].concat(...document.body.children))
              $.off(t3, "mouseover", _);
        ...
        _createTipElement(t2) {
          ...
          return e2.setAttribute("id", i2), this._isAnimated() && e2.classList.add(Ee), e2;
        }
        setContent(t2) {
        ...
        _setListeners() {
          ...
          for (const e2 of t2)
            if ("click" === e2)
              $.on(this._element, this.constructor.eventName("click"), this._config.selector, (t3) => this.toggle(t3));
            else if ("manual" !== e2) {
              const t3 = e2 === Ie ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), i2 = e2 === Ie ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
              $.on(this._element, t3, this._config.selector, (t4) => {
                const e3 = this._initializeOnDelegatedTarget(t4);
                e3._activeTrigger["focusin" === t4.type ? Oe : Ie] = true, e3._enter();
              }), $.on(this._element, i2, this._config.selector, (t4) => {
                const e3 = this._initializeOnDelegatedTarget(t4);
                e3._activeTrigger["focusout" === t4.type ? Oe : Ie] = e3._element.contains(t4.relatedTarget), e3._leave();
              });
            }
          this._hideModalHandler = () => {
            this._element && this.hide();
          }, $.on(this._element.closest(ke), Le, this._hideModalHandler), this._config.selector ? this._config = { ...this._config, trigger: "manual", selector: "" } : this._fixTitle();
        }
        _fixTitle() {
        ...
        _configAfterMerge(t2) {
          return t2.container = false === t2.container ? document.body : c(t2.container), "number" == typeof t2.delay && (t2.delay = { show: t2.delay, hide: t2.delay }), t2.originalTitle = this._element.getAttribute("title") || "", "number" == typeof t2.title && (t2.title = t2.title.toString()), "number" == typeof t2.content && (t2.content = t2.content.toString()), t2;
        }
        _getDelegateConfig() {
          const t2 = {};
      ...
      class Je extends V {
        ...
        _activate(t2, e2) {
          t2 && (t2.classList.add(Qe), this._activate(r(t2)), this._queueCallback(() => {
            "tab" === t2.getAttribute("role") ? (t2.focus(), t2.removeAttribute("tabindex"), t2.setAttribute("aria-selected", true), this._toggleDropDown(t2, true), $.trigger(t2, "shown.bs.tab", { relatedTarget: e2 })) : t2.classList.add(Ye);
        ...
        _keydown(t2) {
          ...
          i2 && Je.getOrCreateInstance(i2).show();
        }
        _getChildren() {
        ...
        _toggleDropDown(t2, e2) {
          ...
          s2(".dropdown-toggle", Qe), s2(".dropdown-menu", Ye), s2(".dropdown-item", Qe), i2.setAttribute("aria-expanded", e2);
        }
...
// dep:bootstrap_dist_js_bootstrap__min
var bootstrap_dist_js_bootstrap_min_default = require_bootstrap_min();
export {
  bootstrap_dist_js_bootstrap_min_default as default
};
/*!
